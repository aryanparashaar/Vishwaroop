...
export default function ContactFooter() {
  return (
    <footer
      id="contact"
      className="relative border-t border-brand-gold/30 bg-white"
    >
      ...
      */}
      <Section
        id={undefined}
        className="py-0 md:py-0 lg:py-0 bg-gradient-to-b from-slate-50 to-brand-gold/5"
      >
          ...
          <div className="grid gap-12 md:grid-cols-4 items-start">
            ...
            <div className="space-y-4">
              ...
              <p className="text-xs md:text-sm leading-relaxed text-slate-500 font-light">
                An international academic relay designed to combine
                problem-solving, collaboration, and healthy competition for
              ...
              <ul className="space-y-3 text-xs md:text-sm">
                <li className="flex flex-col gap-1">
                  ...
                  <a
                    ...
                    className="font-bold text-brand-navy hover:text-brand-blue transition-colors underline-offset-4"
                  >
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="text-xs md:text-sm text-slate-600">
                  <p className="font-bold text-brand-navy">Monday – Saturday</p>
                  <p>10:00 AM – 7:00 PM</p>
                  <p className="text-[10px] uppercase text-slate-400 font-black mt-1">
                    Working Days Only
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="p-3 rounded-xl bg-white border border-slate-100 shadow-inner">
                <p className="text-[10px] text-slate-400 font-medium">
                  Scan to join our official community updates.
                </p>
              </div>
            </div>
          </div>
